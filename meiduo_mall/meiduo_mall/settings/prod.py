...
SECRET_KEY = '@fxnn^)&xew764ltliso+sx$+__p1rauadz)r^98&zsulqc7bi'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['api.meiduo.site', 'localhost', '127.0.0.1', 'www.meiduo.site']
...
DATABASES = {
    'default': {
        ...
        'PORT': 3306,  # 数据库端口
        'USER': 'meiduo_sy05',  # 数据库用户名
        'PASSWORD': 'meiduo',  # 数据库用户密码
        'NAME': 'meiduo_mall_sy05'  # 数据库名字
    }
}
...
# 支付宝
ALIPAY_APPID = "2016090800464054" # 开发者应用APPID
