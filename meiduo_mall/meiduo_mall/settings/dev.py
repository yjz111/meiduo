...
SECRET_KEY = '5^(y9omt09)x5hl=yop2#3f!n=51yz2bvl1o2r(35%et6q))3!'
...
INSTALLED_APPS = [
    ...
    'corsheaders',
    'django_crontab', #定时任务
    'pics.apps.PicsConfig',#测试上传图片子应用
    'ckeditor',  # 富文本编辑器
...
# redis_conn = StrictRedis(host='172.16.179.139', port=6379, db=1)
...
# QQ登录参数
QQ_CLIENT_ID = '101474184' # 开发应用ID
QQ_CLIENT_SECRET = 'c6ce949e04e12ecc909ae6a8b09b637c' # 开发应用key
...
EMAIL_PORT = 25
# 发送邮件的邮箱
EMAIL_HOST_USER = 'yjz_uzi@163.com'
# 在邮箱中设置的客户端授权密码
EMAIL_HOST_PASSWORD ='python3'
# 收件人看到的发件人
EMAIL_FROM = '美多商城<yjz_uzi@163.com>'
...
CKEDITOR_UPLOAD_PATH = ''  # 上传图片保存路径，使用了FastDFS，所以此处设为''# 指定生成静态文件保存的目录
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://192.168.31.137:9200/',  # 此处为elasticsearch运行的服务器ip地址，端口号固定为9200
